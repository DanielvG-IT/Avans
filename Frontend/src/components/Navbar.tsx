...
export function Navbar() {
  ...
  const navLinks = [
    { to: "/keuzehulp", label: "Keuzehulp", role: "STUDENT" },
        ...
        <div className="px-4 py-6 space-y-4">
          ...
          {user && (
            <div className="pt-4 border-t border-gray-100 dark:border-gray-800">
              ...
              <button
                onClick={handleLogout}
                className="w-full flex items-center justify-center gap-2 px-4 py-3 text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/10 rounded-xl font-medium transition-colors">
