      ...
      <div className="container w-full mx-auto px-4 py-10 max-w-5xl">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Vul de details in voor de nieuwe module.
          </p>
        </div>
        ...
        {isStartDateInPast && startDate && (
          <div className="mb-6 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 text-yellow-800 dark:text-yellow-300">
            ⚠️ De startdatum kan niet in het verleden liggen. Kies een
            toekomstige datum.
          </div>
        )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                  placeholder="Wat leert de student?"
                />
              </div>
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                  Selecteer één of meer locaties
                </p>
                <div className="flex flex-wrap gap-2">
                  {(!locations || locations.length === 0) && !loadingData && (
              ...
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                  Kies tags of voeg een eigen tag toe
                </p>
                <div className="flex flex-wrap gap-2 mb-3">
                  {(!tags || tags.length === 0) && !loadingData && (
                    <p className="text-sm text-gray-500 dark:text-gray-400">
