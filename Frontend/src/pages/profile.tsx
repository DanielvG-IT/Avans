...
export function ProfilePage() {
  ...
  if (isLoading) {
    return <div className="p-8 text-center text-gray-900 dark:text-white">Loading...</div>;
  }

  if (!user) {
    return <div className="p-8 text-center text-gray-900 dark:text-white">Not authenticated</div>;
  }

  return (
    <div className="container mx-auto p-8 pt-20 max-w-6xl">
      <div className="text-center mb-10">
        <h1 className="text-4xl font-bold mb-2 text-gray-900 dark:text-white">Profiel</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 lg:col-span-2 relative flex flex-col transition-colors">
          <div className="flex justify-between items-start mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">Gegevens</h2>
            <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 transition-colors">
          <h2 className="text-xl font-semibold mb-6 text-gray-900 dark:text-white">Favoriete Modules</h2>
          <div className="space-y-4">
            <p className="text-gray-500 dark:text-gray-400 italic">Geen favoriete modules gevonden.</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 transition-colors">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Recent aanbevolen modules</h2>
            <button className="bg-blue-600 text-white px-3 py-1 rounded text-sm hover:bg-blue-700 transition-colors">
              Aanpassen
            </button>
          </div>
          <div className="space-y-4">
            <p className="text-gray-500 dark:text-gray-400 italic">Geen aanbevolen modules gevonden.</p>
          </div>
        </div>
      </div>
    </div>
