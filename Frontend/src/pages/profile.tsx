	...
	return (
		<div className="container mx-auto p-8 max-w-6xl">
			<div className="text-center mb-10">
				...
				<p className="text-gray-600">Bekijken en bewerk hier je gebruikersgegevens</p>
			</div>
				...
				<div className="bg-white shadow-md rounded-lg p-6 lg:col-span-2 relative flex flex-col">
					...
					<div className="space-y-6 flex-grow">
						<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-gray-100 pb-4">
							<div>
								<label className="block text-sm font-medium text-gray-500 mb-1">Gebruikersnaam</label>
						...
						<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-gray-100 pb-4">
							<div>
								<label className="block text-sm font-medium text-gray-500 mb-1">Lid sinds</label>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
				...
				<div className="bg-white shadow-md rounded-lg p-6">
					<div className="flex justify-between items-center mb-6">
						...
						<button className="bg-blue-600 text-white px-3 py-1 rounded text-sm hover:bg-blue-700">Aanpassen</button>
					</div>
					<div className="space-y-4">
