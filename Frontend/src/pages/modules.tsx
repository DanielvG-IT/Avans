...
export function ModulesPage() {
  ...
  const { modules, loading, error, filterOptions, filterModules } =
    useModulesList();
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
      ...
      {error && (
        <div className="container mx-auto px-4 py-8">
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 text-red-800 dark:text-red-300 transition-colors">
            {error}
          </div>
        </div>
      )}
                ...
                {filteredModules.length === 0 ? (
                  ...
                  paginatedModules.map((module) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col sm:items-end justify-between gap-3 shrink-0 text-left sm:text-right border-t sm:border-t-0 pt-4 sm:pt-0 border-gray-100 dark:border-gray-700 mt-2 sm:mt-0">
